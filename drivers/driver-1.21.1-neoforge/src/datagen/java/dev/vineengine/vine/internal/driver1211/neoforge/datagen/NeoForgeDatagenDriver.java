 ...
 * driver instead of the loader one — the loader's bootstrap needs a mod event bus that only
 * a game has, and the cooking pass needs exactly two things from a driver: a structural
 ...
 * dev.vineengine.vine.internal.driver1211.neoforge.boot.NeoForge1211Driver}); two driver
 ...
 * neither depends on a probe.
 */
public final class NeoForgeDatagenDriver implements VineDriver {
    ...
    public CellInfo cell() {
        return new CellInfo(0, LoaderFamily.NEOFORGE, Set.of());
    }
