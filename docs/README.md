...
| 01 | Core runtime (boot, events, probes) | M0→M1 | 00 | in-progress | [sub-01](subsystems/sub-01-core-runtime.md) |
| 02 | Registry & descriptors | M0→M1 | 00, 01 | in-progress | [sub-02](subsystems/sub-02-registry.md) |
...
| 14 | Sessions & parties | M1 basics → M3 full | 03, 05 | in-progress | [sub-14](subsystems/sub-14-sessions.md) |
...
| 18 | Driver 1.21.1 (NF + Fabric) | M0 | 00, 01 | in-progress | [sub-18](subsystems/sub-18-driver-1211.md) |
