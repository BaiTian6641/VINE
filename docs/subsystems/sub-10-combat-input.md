...
- **Acceptance:** end-to-end TCK: §5 attack on a multipart testmod entity → 110 damage, head part wounds, hitstop gap in tick-trace; adjacent unregistered mob behaves pure-vanilla.
