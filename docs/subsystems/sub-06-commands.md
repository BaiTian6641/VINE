...
- **Outstanding (client half):** `vine-client-api`/client drivers need the client runner — sub-21's client cell; a headless dedicated server cannot host a client command or prove its invisibility to the server. Recorded there, not claimed here.
